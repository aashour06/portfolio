        ...
        <section id="projects" className="section projects" ref={ref}>
            <div className="container">
                ...
                <h2 className="section-title reveal">
                    {t.projects.title1}<span className="gold-text">{t.projects.title2}</span>
                </h2>
                    ...
                    {projects.map((p, i) => (
                        ...
                        >
                            <div className="project-card__top">
                                <div className="project-card__icon-wrap" style={{ '--accent': p.color }}>
                                    <span className="project-card__icon">{p.icon}</span>
                                </div>
                                <div className="project-card__links">
                                    <a href={p.github} className="project-card__link" aria-label="GitHub">
